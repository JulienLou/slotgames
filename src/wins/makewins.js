...
const makeWins = (allRollers, randNum, basicLosingArray) => {
  ...
  else if(randNum > 150 && randNum <= 160){ // (B2 C2 D2) fig.34
  ...
  else if(randNum > 160 && randNum <= 170){ // (B1 C1 D1) fig.35
    buildLosingPositionWithDouble();
  ...
  else if(randNum > 170 && randNum <= 180){ // (B3 C3 D3) fig.36
    buildLosingPositionWithDouble();
  ...
  else if(randNum > 180 && randNum <= 190){ // (B1 C2 D3) fig.37
    buildLosingPositionWithDouble();
    modelRand = allRollers[1][0]; // B1
    allRollers[1].splice(0, 1, modelRand);
    allRollers[2].splice(1, 1, modelRand);
  ...
  else if(randNum > 190 && randNum <= 200){ // (B3 C2 D1) fig.38
    buildLosingPositionWithDouble();
    modelRand = allRollers[1][2]; // B3
    allRollers[1].splice(2, 1, modelRand);
    allRollers[2].splice(1, 1, modelRand);
  ...
  else if(randNum > 200 && randNum <= 210){ // (C2 D2 E2) fig.39
    buildLosingPositionWithDouble();
  ...
  else if(randNum > 210 && randNum <= 220){ // (C1 D1 E1) fig.40
    buildLosingPositionWithDouble();
  ...
  else if(randNum > 220 && randNum <= 230){ // (C3 D3 E3) fig.41
    buildLosingPositionWithDouble();
  ...
  else if(randNum > 230 && randNum <= 240){ // (C1 D2 E3) fig.42
    buildLosingPositionWithDouble();
    modelRand = allRollers[2][0]; // C1
    allRollers[2].splice(0, 1, modelRand);
    allRollers[3].splice(1, 1, modelRand);
  ...
  else if(randNum > 240 && randNum <= 250){ // (C3 D2 E1) fig.43
    buildLosingPositionWithDouble();
    modelRand = allRollers[2][2]; // C3
    allRollers[2].splice(2, 1, modelRand);
    allRollers[3].splice(1, 1, modelRand);
